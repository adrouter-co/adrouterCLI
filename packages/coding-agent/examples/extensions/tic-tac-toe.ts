...
import type { ExtensionAPI, ExtensionContext, Theme, ToolExecutionMode } from "@adrouter/cli";
import { type Component, matchesKey, Text, truncateToWidth, visibleWidth } from "@adrouter/tui";
