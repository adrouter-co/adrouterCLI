...
import type { ExtensionAPI, ExtensionContext } from "@adrouter/cli";
import { CONFIG_DIR_NAME, DynamicBorder, getAgentDir } from "@adrouter/cli";
import { Container, Key, type SelectItem, SelectList, Text } from "@adrouter/tui";
