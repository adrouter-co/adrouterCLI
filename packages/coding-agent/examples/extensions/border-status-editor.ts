import { CustomEditor, type ExtensionAPI, type ExtensionContext, type KeybindingsManager } from "@adrouter/cli";
import type { Component, EditorTheme, TUI } from "@adrouter/tui";
