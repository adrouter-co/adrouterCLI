...
import { complete, type Message } from "@adrouter/ai/compat";
import type { ExtensionAPI, SessionEntry } from "@adrouter/cli";
import { BorderedLoader, convertToLlm, serializeConversation } from "@adrouter/cli";
