...
import type { BashToolDetails, EditToolDetails, ExtensionAPI, ReadToolDetails } from "@adrouter/cli";
import { createBashTool, createEditTool, createReadTool, createWriteTool } from "@adrouter/cli";
