...
```bash
npm install -g --ignore-scripts @adrouter/cli
```
...
npm uninstall -g @adrouter/cli

# pnpm
pnpm remove -g @adrouter/cli

# Yarn
yarn global remove @adrouter/cli

# Bun
bun uninstall -g @adrouter/cli
```
