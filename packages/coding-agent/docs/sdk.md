...
```typescript
import { createAgentSession, SessionManager } from "@adrouter/cli";
...
The `Agent` class (from `@adrouter/agent-core`) handles the core LLM interaction. Access it via `session.agent`.
...
```typescript
import { getModel } from "@adrouter/ai";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@adrouter/cli";
...
```typescript
import { createAgentSession } from "@adrouter/cli";
...
import { createAgentSession, defineTool } from "@adrouter/cli";
...
```typescript
import type { InlineExtension } from "@adrouter/cli";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@adrouter/cli";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@adrouter/cli";
