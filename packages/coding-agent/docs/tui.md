...
**Source:** [`@adrouter/tui`](https://github.com/badlogic/pi-mono/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@adrouter/tui";
...
```typescript
import { Container, type Focusable, Input } from "@adrouter/tui";
...
Import from `@adrouter/tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@adrouter/tui";
```
...
```typescript
import { matchesKey, Key } from "@adrouter/tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@adrouter/tui";
...
```typescript
import { getMarkdownTheme } from "@adrouter/cli";
import { Markdown } from "@adrouter/tui";
...
For letting users pick from a list of options. Use `SelectList` from `@adrouter/tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@adrouter/cli";
import { DynamicBorder } from "@adrouter/cli";
import { Container, type SelectItem, SelectList, Text } from "@adrouter/tui";
...
```typescript
import { BorderedLoader } from "@adrouter/cli";
...
For toggling multiple settings. Use `SettingsList` from `@adrouter/tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@adrouter/cli";
import { Container, type SettingItem, SettingsList, Text } from "@adrouter/tui";
...
import { matchesKey, truncateToWidth } from "@adrouter/tui";
