...
To report a security issue, follow the AdRouterCLI [Security Policy](https://github.com/adrouter/adrouterCLI/blob/main/SECURITY.md). Do not open a public issue for security-sensitive reports.
