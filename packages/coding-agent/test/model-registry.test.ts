...
import type { AnthropicMessagesCompat, Api, Context, Model, OpenAICompletionsCompat } from "@adrouter/ai/compat";
import { getApiProvider, getSupportedThinkingLevels } from "@adrouter/ai/compat";
import { getOAuthProvider } from "@adrouter/ai/oauth";
