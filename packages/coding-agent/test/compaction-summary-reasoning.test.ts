...
import type { AssistantMessage, Model } from "@adrouter/ai";
...
vi.mock("@adrouter/ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@adrouter/ai/compat")>();
	return {
		...actual,
