...
import { Agent, type AgentEvent, type AgentTool } from "@adrouter/agent-core";
import { type AssistantMessage, type AssistantMessageEvent, EventStream, getModel } from "@adrouter/ai/compat";
