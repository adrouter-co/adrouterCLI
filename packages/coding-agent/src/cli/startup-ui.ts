import { ProcessTerminal, setKeybindings, TUI } from "@adrouter/tui";
...
const OFFICIAL_PACKAGE_NAME = "@adrouter/cli";
const UPSTREAM_APP_NAME = "pi";
const UPSTREAM_CONFIG_DIR_NAME = ".pi";
...
function isOfficialDistribution({ packageName, appName, configDirName }: DistributionMetadata): boolean {
	return (
		...
		configDirName === UPSTREAM_CONFIG_DIR_NAME
	);
}
 ...
 * - this is the upstream distribution (AdRouterCLI intentionally skips this theme/analytics setup)
