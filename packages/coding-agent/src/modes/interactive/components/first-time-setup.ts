import { Container, getKeybindings, Spacer, Text } from "@adrouter/tui";
		...
		if (this.step === "theme") {
			...
			this.addChild(
				new Text(
					theme.fg(
						"muted",
						"Opting in stores a tracking identifier in settings.json and enables anonymous\nusage analytics. This helps us to better debug, reproduce, and resolve issues\nand bugs within AdRouterCLI. You can observe what is shared using /privacy and\nmake changes anytime in settings.json.",
					),
					1,
					0,
				),
