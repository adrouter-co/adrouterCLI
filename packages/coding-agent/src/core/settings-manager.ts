...
import type { Transport } from "@adrouter/ai";
...
export interface Settings {
	/** Global AdRouter sponsorship preference. ADROUTER_AD_MODE=off overrides it. */
	adsEnabled?: boolean;
...
export class SettingsManager {
	...
	getAdsEnabled(): boolean {
		return this.settings.adsEnabled ?? true;
	}

	setAdsEnabled(enabled: boolean): void {
		this.globalSettings.adsEnabled = enabled;
		this.markModified("adsEnabled");
		this.save();
	}
