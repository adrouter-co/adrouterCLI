...
import * as _bundledPiTui from "@adrouter/tui";
...
// avoiding a circular dependency. Extensions can import from @adrouter/cli.
...
const VIRTUAL_MODULES: Record<string, unknown> = {
	...
	"@adrouter/agent-core": _bundledPiAgentCore,
	"@adrouter/tui": _bundledPiTui,
...
function getAliases(): Record<string, string> {
	...
	const piAgentCoreEntry = resolveWorkspaceOrImport("agent/dist/index.js", "@adrouter/agent-core");
	const piTuiEntry = resolveWorkspaceOrImport("tui/dist/index.js", "@adrouter/tui");
	// Extensions resolve the pi-ai root to the compat entrypoint (a strict
	// superset of the core entrypoint): existing extensions using the old
	// global API keep working at runtime until compat is removed.
	...
	_aliases = {
		"@adrouter/cli": piCodingAgentEntry,
