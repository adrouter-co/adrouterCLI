...
import type { AgentMessage, StreamFn, ThinkingLevel } from "@adrouter/agent-core";
import type { AssistantMessage, Context, Model, SimpleStreamOptions, Usage } from "@adrouter/ai/compat";
import { completeSimple } from "@adrouter/ai/compat";
