import { type AgentMessage, uuidv7 } from "@adrouter/agent-core";
 ...
 * Encodes cwd into a safe directory name under ~/.adrouter/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.adrouter/agent/sessions/<encoded-cwd>/).
	 */
