...
export class ProcessTerminal implements Terminal {
	...
	start(onInput: (data: string) => void, onResize: () => void): void {
		...
		// Own a full-screen alternate buffer while the TUI is active.
		process.stdout.write("\x1b[?1049h\x1b[2J\x1b[H");
		process.stdout.write("\x1b[?1000l\x1b[?1002l\x1b[?1003l\x1b[?1006l");
		if (process.env.PI_TUI_NATIVE_SELECTION !== "1") {
	...
	stop(): void {
		...
		// Disable bracketed paste/mouse tracking and leave the alternate screen.
		process.stdout.write("\x1b[?2004l\x1b[?1006l\x1b[?1003l\x1b[?1002l\x1b[?1000l\x1b[?1049l");
