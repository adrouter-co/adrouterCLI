...
Credentials are local secrets. Sanitized bug reports must remove prompts, output, tool payloads, filesystem paths, account identifiers, and keys unless the reporter deliberately includes the minimum necessary material through a private security channel.
