...
The installed AdRouter coding catalog is usable offline and contains `agnes-2.0-flash`,
`agnes-2.5-flash`, `deepseek-v4-flash`, `deepseek-v4-pro`, `mimo-v2.5`, and `mimo-v2.5-pro`.
