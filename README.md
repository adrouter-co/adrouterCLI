...
AdRouter. Version `0.81.0-beta.9` is an MIT-licensed public-source and npm
...
```sh
gh api repos/adrouter/adrouterCLI/git/ref/tags/v0.81.0-beta.9
gh api repos/adrouter/adrouterCLI/tarball/v0.81.0-beta.9 > adrouterCLI-v0.81.0-beta.9.tar.gz
```
