...
AdRouter. Version `0.81.0-beta.5` is an MIT-licensed public-source and npm
...
```sh
gh api repos/adrouter/adrouterCLI/git/ref/tags/v0.81.0-beta.5
gh api repos/adrouter/adrouterCLI/tarball/v0.81.0-beta.5 > adrouterCLI-v0.81.0-beta.5.tar.gz
```
